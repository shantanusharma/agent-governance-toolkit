...
class GovernedAgent:
    ...
    async def verify_peer(self, peer_did: str, min_score: int = 700) -> bool:
        ...
        result = await handshake.verify(peer_did=peer_did, required_score=min_score)
...
class SupervisorAgent(GovernedAgent):
    ...
    def create_specialists(self):
        ...
        self.specialists["technical"] = SpecialistAgent(technical_identity, TicketType.TECHNICAL)
        ...
        self.specialists["billing"] = SpecialistAgent(billing_identity, TicketType.BILLING)
        ...
        self.specialists["escalation"] = SpecialistAgent(escalation_identity, TicketType.ESCALATION)
    ...
    async def route_ticket(self, ticket: Ticket):
        ...
        verified = await self.verify_peer(specialist.identity.did, min_score=700)
