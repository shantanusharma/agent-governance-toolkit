...
[bold]Trust Score: {response["initial_trust_score"]}/1000[/bold]"""
    ...
    table.add_row(
        "Policy Compliance",
        f"{dimensions['policy_compliance']}/100",
        get_stars(dimensions["policy_compliance"]),
    )
    table.add_row(
        "Resource Efficiency",
        f"{dimensions['resource_efficiency']}/100",
        get_stars(dimensions["resource_efficiency"]),
    )
    table.add_row(
        "Output Quality",
        f"{dimensions['output_quality']}/100",
        get_stars(dimensions["output_quality"]),
    )
    table.add_row(
        "Security Posture",
        f"{dimensions['security_posture']}/100",
        get_stars(dimensions["security_posture"]),
    )
    table.add_row(
        "Collaboration Health",
        f"{dimensions['collaboration_health']}/100",
        get_stars(dimensions["collaboration_health"]),
    )
